...
export declare const ALLOWED_CHILDREN: (import("react").FC<import("../toolbar-primitives").StackToolbarIconProps> | import("react").FC<import("../toolbar-primitives").StackToolbarBadgeProps>)[];
