...
exports.ALLOWED_CHILDREN = exports.StackToolbarMenuAction = exports.StackToolbarMenu = void 0;
exports.computeMenuLabelAndTitle = computeMenuLabelAndTitle;
exports.convertStackToolbarMenuPropsToRNHeaderItem = convertStackToolbarMenuPropsToRNHeaderItem;
exports.convertImageIconToPlatformIcon = convertImageIconToPlatformIcon;
...
const StackToolbarMenu = (props) => {
    ...
    const validChildren = (0, react_1.useMemo)(() => (0, children_1.filterAllowedChildrenElements)(props.children, exports.ALLOWED_CHILDREN), [props.children]);
